...
export function formatBeeHiiv(data: NewsletterData): PlatformOutput {
  ...
  const signalsList = data.signalsFromTheEdge.map(s =>
    "<li style=\"margin-bottom: 12px; font-style: italic; padding-left: 8px; border-left: 2px solid #6C5CE7;\"><strong style=\"font-weight: 700; color: #1a1a1a;\">" + s.title + ":</strong> " + s.content + "</li>"
  ).join("\n");

...
function extractSection(md, startRx, endRx) {
    const lines = md.split("\n");
    let inSection = false;
    const result = [];
...
function parseStoryList(md, startRx, endRx) {
...
function parseBulletList(md, startRx, endRx) {
    const section = extractSection(md, startRx, endRx);
    return section
        .split("\n")
...
// ── HTML Dashboard ────────────────────────────────────────────────────────────
function buildDashboard(data, outputs, mdSource, beehiivHtml) {

...
exports.analyseArticle = analyseArticle;
exports.analyseArticles = analyseArticles;
...
JSON only, no explanation outside the JSON block.`;
    try {
        ...
        return {
            ...
            crossDomainThemes: [],
            relevance: "Medium",
            keyQuote: article.description?.slice(0, 100) || `Read more at ${article.url}`,
        };
    }
}
async function analyseArticles(articles) {
    const analyses = [];

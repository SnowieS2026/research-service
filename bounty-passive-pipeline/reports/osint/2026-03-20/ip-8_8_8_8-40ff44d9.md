...
**Generated:** 2026-03-20T13:57:44.662Z  
**Duration:** 3s  
**Flags:** (none)  
...
- **🟢 [85%]** `city`: Ashburn
- **🟢 [85%]** `isp`: Google LLC
- **🟢 [85%]** `asn`: AS15169 Google LLC
- **🟢 [80%]** `org`: Google Public DNS
- **🟢 [80%]** `hosting`: Yes – appears to be a hosting/VPN/数据中心 IP

### RDAP

- **🟢 [85%]** `netname`: GOGL
- **🟢 [80%]** `range`: 8.8.8.0 – 8.8.8.255
...
- **⚪ [0%]** `note`: Use --deep flag to enable port scanning / banner grabbing

## Errors

- BGPView lookup failed: TypeError: fetch failed
          ...
          "entities": [
            {
              ...
              "events": [
                {
                  "eventAction": "last changed",
                  "eventDate": "2024-08-01T17:54:23-04:00"
                },
                {
                  "eventAction": "registration",
            ...
            },
            {
              ...
              "events": [
                {
                  "eventAction": "last changed",
                  "eventDate": "2025-11-10T07:10:31-05:00"
                },
                {
                  "eventAction": "registration",
...
- country → United States (IPApi)
- region → Virginia (IPApi)
- city → Ashburn (IPApi)
- isp → Google LLC (IPApi)
- asn → AS15169 Google LLC (IPApi)
- netname → GOGL (RDAP)
- ptr → dns.google (ReverseDNS)
- org → Google Public DNS (IPApi)
- hosting → Yes – appears to be a hosting/VPN/数据中心 IP (IPApi)
- range → 8.8.8.0 – 8.8.8.255 (RDAP)

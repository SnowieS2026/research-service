# OSINT Report – email: test@example.com

**Generated:** 2026-03-20T04:08:18.063Z  
**Duration:** 23s  
**Flags:** (none)  
...
- **🟢 [90%]** `valid_format`: Yes – "test@example.com" appears valid
...
- Email web search failed: TypeError: fetch failed
...
- valid_format → Yes – "test@example.com" appears valid (FormatCheck)

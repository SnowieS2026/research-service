...
| Severity | **MEDIUM** |
| CVSS | 6 |
| Reasons | 2 new asset(s) added to scope; Allowed techniques updated; 19 asset(s) removed from scope |

## Summary

2 new assets added to the scope of bugcrowd.com on bugcrowd. 19 assets removed from scope. Allowed testing techniques list updated.
...
| scope_assets | *.zendesk.com,*.zdusercontent.com | *.zendesk.com,*.zdusercontent.com |
| exclusions |  |  |
| reward_range | unknown | unknown |
| payout_notes |  |  |
| allowed_techniques |  |  |
| last_seen_at | 2026-03-25T01:59:14.812Z | 2026-03-25T01:59:14.812Z |
| source_snapshot_hash | 0d57056dd8b1 | 0d57056dd8b1 |
...
**Scope expansion detected** – 2 new asset(s) added. Review the new targets and begin reconnaissance. Priority targets: *.zendesk.com, *.zdusercontent.com
...
```json
{
  ...
  "last_seen_at": "2026-03-25T01:59:14.812Z",
  "source_snapshot_hash": "0d57056dd8b1",
  "rewards": [],
  "prevProgram": {
    "platform": "bugcrowd",
  ...
  "diff": {
    ...
    "newHash": "b1da769254730bd75283f28a6f70385d426897d51e2d6f3705c899e042ecced9",
    "addedFields": [
      "rewards"
    ],
    "removedFields": [],

 ...
 */
export function determinePlatform(urlOrDomain) {
 ...
 */
export function seedFromTargets(targets) {
    const results = [];
 ...
 */
function resolveProgramUrl(target, platform) {
 ...
 */
export function extractProgramNameFromUrl(url, platform) {
    try {
        const u = new URL(url);
